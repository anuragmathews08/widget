export const CircleUI = ({ rangeVal }) => {
  return (
    <div
      aria-label="dotted-circle"
      className="w-[12rem] h-[12rem] rounded-full border-2 border-white border-dashed relative"
    >
      <svg className="stroke-[3px] stroke-white fill-none absolute top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%]">
        <circle
          cx="150"
          cy="74"
          r="72"
          style={{
            strokeDasharray: "452",
            strokeDashoffset: 452 - (452 * rangeVal * 10) / 100,
